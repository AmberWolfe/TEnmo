...
namespace TenmoServer.DAO
{
    public class UserSqlDAO : IUserDAO
    {
        ...
        public User GetUserById(int userId)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT user_id, username, password_hash, salt FROM users WHERE username = @userId", conn);
        ...
        // method to return the balance for a user
        public decimal GetUserBalance(int userId)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand command = new SqlCommand("SELECT balance FROM accounts WHERE user_id = @user_id", connection);
